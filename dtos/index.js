...
module.exports = {
    ...
    CreateUserDTO: require('./CreateUserDTO'),
    UpdateUserDTO: require('./UpdateUserDTO'),
    ApartmentDTO: require('./ApartmentDTO'),
    CreateApartmentDTO: require('./CreateApartmentDTO'),
    UpdateApartmentDTO: require('./UpdateApartmentDTO'),
